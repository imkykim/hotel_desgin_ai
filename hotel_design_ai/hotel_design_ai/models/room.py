...
class Room:
    ...
    def __init__(
        ...
        floor: Optional[Union[int, List[int]]] = None,
        ...
        Args:
            ...
            floor: Preferred floor (0 = ground) or list of preferred floors
        ...
        # Handle preferred_floors - extract from floor if it's a list, or set to None
        if isinstance(floor, list):
            self.preferred_floors = floor
        else:
            self.preferred_floors = [floor] if floor is not None else None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "height": self.height,
            "floor": self.floor,
            "preferred_floors": self.preferred_floors,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Room":
        ...
        if "preferred_floors" in data:
            room.preferred_floors = data["preferred_floors"]
